...
def main(args) : 
    ...
    # pdb.set_trace()
        ...
        if run_tests : 
            print('denoiser tests')
            denoiser_trainer.test(trained_denoiser, datamodule)
            print('discriminator tests')
            discriminator_trainer.test(discriminator, datamodule)
        ...
        if train_discriminator : 
            discrminator_checkpoint_path = get_checkpoint('discriminator', experiment_version, config)
            
        trained_discriminator = Efficient_U_DISC.load_from_checkpoint(checkpoint_path = discrminator_checkpoint_path, 
