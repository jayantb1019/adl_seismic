...
# from patcher import extract_all_patches_2d, unpatch_from_all_patches_2d
from random_noise import add_random_noise, add_random_noise_patch_mean


class SEGYDataset(IterableDataset) : 

    def __init__(self, segy_filename, config_path, mode, **kwargs) : 
        super().__init__()
        ...
        self.noise_factors = self.config['patch_based_training']['noise_factors']
    ...
    def __iter__(self) : 
        ...
        for _ in range(self.n_samples_per_epoch_per_worker) : 
            ...
            noisy_patch , noise = add_random_noise_patch_mean(patch, random_noise_factor)
